      ...
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          {navCta?.label && navCta?.href && (
            <Link
              href={navCta.href}
              className="font-[family-name:var(--font-functional)] font-semibold text-xs uppercase tracking-widest rounded-sm border border-[#535D66] text-white px-4 py-2 hover:bg-[#535D66] transition-colors"
            >
              {navCta.label}
            </Link>
          )}
        ...
        <nav className="md:hidden bg-black border-t border-[#1a1a1a] px-6 py-8 flex flex-col gap-6">
          ...
          {navCta?.label && navCta?.href && (
            <Link
              href={navCta.href}
              onClick={() => setOpen(false)}
              className="font-[family-name:var(--font-functional)] font-semibold text-sm uppercase tracking-widest rounded-sm text-white border border-[#535D66] px-4 py-3 text-center hover:bg-[#535D66] transition-colors"
            >
              {navCta.label}
            </Link>
          )}
