    ...
    <section className="bg-black text-white py-24">
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        {s.buttons && s.buttons.length > 0 ? (
            ...
            {s.buttons.map((btn: CtaButton) => {
              ...
              return (
                <a
                  ...
                  className={`inline-block px-10 py-4 rounded-sm font-[family-name:var(--font-functional)] font-semibold text-sm uppercase tracking-widest transition-colors ${
                    isPrimary
          ...
          <a
            href="/contact"
            className="inline-block px-10 py-4 rounded-sm border border-white text-white font-[family-name:var(--font-functional)] font-semibold text-sm uppercase tracking-widest hover:bg-white hover:text-black transition-colors"
          >
            Get In Touch
          </a>
        )}
