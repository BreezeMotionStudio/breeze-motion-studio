...
function CtaLink({ cta }: { cta: CtaButton }) {
  ...
  return (
    <a
      href={cta.url}
      className={`inline-block px-8 py-3 rounded-sm font-[family-name:var(--font-functional)] font-semibold text-sm uppercase tracking-widest transition-colors ${
        isPrimary
    ...
    <section className="relative overflow-hidden bg-bms-dark-500 text-white py-24">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mt-12">
          <a
            href="/studios"
            className="inline-block px-8 py-3 rounded-sm border border-white text-white font-[family-name:var(--font-functional)] font-semibold text-sm uppercase tracking-widest hover:bg-white hover:text-black transition-colors"
          >
            Explore All Studios
          </a>
        </div>
