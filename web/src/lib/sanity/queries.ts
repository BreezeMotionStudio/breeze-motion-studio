...
export const HOME_PAGE_QUERY = defineQuery(
  `*[_type == "homePage"][0]{
    sections[disabled != true]{
      ...
      clientLogos[disabled != true]{_key, client->{name, logo{asset->{url, metadata{dimensions}}, alt}}, logoOverride{asset->{url, metadata{dimensions}}, alt}},
...
export const ABOUT_PAGE_QUERY = defineQuery(
  `*[_type == "aboutPage"][0]{
    sections[disabled != true]{
      ...
      overviewImage{asset->{url, metadata{dimensions}}, alt},
